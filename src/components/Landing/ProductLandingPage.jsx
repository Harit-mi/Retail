          ...
          <div className="bg-[#0F1F35] rounded-2xl max-w-3xl w-full overflow-hidden border-2 border-white/20 shadow-2xl">
            ...
            <div className="p-4 bg-slate-900 flex justify-center">
              <video
                ...
                playsInline
                preload="auto"
                className="w-full h-auto max-h-[75vh] rounded-lg border border-white/10 shadow-lg"
              >
                <source src="/dukaan_pos_demo_walkthrough_voiceover.webm" type="video/webm" />
                <source src="/dukaan_pos_demo_walkthrough.webm" type="video/webm" />
                <source src="/dukaan_pos_demo_walkthrough_hindi.webm" type="video/webm" />
                <p className="text-xs text-slate-300 p-4 text-center">
                  Your browser does not support inline WebM video playback. You can download the video directly:
                  <a href="/dukaan_pos_demo_walkthrough.webm" download className="text-amber-400 underline font-bold ml-1">
