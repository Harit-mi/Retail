...
export const ProductLandingPage = () => {
  ...
  const verticals = [
    {
      ...
      tagline: "Weight-based selling & FMCG batch expiry",
      features: [
    ...
    },
    {
      ...
      tagline: "Size, Color & Style Matrix",
      features: [
    ...
    },
    {
      ...
      tagline: "Serial No. & IMEI Billing",
      features: [
    ...
    },
    {
      ...
      tagline: "Stylist Commissions & Service Combos",
      features: [
    ...
    },
    {
      ...
      tagline: "KOT Routing & Table Management",
      features: [
    ...
    },
    {
      ...
      tagline: "Live Gold/Silver Rates & Hallmark",
      features: [
  ...
  const coreFeatures = [
    {
      ...
      desc: "Process transactions in 0.8 seconds with F2 search, F4 customer link, and F8 checkout shortcuts.",
      badge: "F2 • F4 • F8",
    },
    {
      icon: BookOpen,
      title: "Udhaar Khata & Loyalty",
      desc: "Complete credit ledger tracking with green payment receipts, red debt balances, and VIP reward ranks.",
      badge: "Udhaar + Points",
    },
    {
      icon: Barcode,
      title: "A4 Barcode Sticker Printing",
      desc: "Auto-fill 24 or 40 labels per A4 sheet with vector EAN-13 barcodes, MRP tags, and store logo.",
      badge: "A4 24/40 Labels",
    },
    {
      icon: MessageSquare,
      title: "WhatsApp Marketing",
      desc: "Broadcast payment reminders and festive campaign offers via 1-tap WhatsApp deep links.",
      badge: "1-Tap Links",
    },
    {
      icon: FileSpreadsheet,
      title: "GST & GSTR-1 Analytics",
      desc: "Real-time revenue pulse, live payment mix breakdown, and GSTR-1 CSV exports with injection shields.",
      badge: "GSTR-1 CSV",
    },
    {
      icon: Lock,
      title: "DPDP Act & PIN Security",
      desc: "100% offline-first local crypto storage, 4-digit cashier PIN counter lock, and Right-to-Erasure tools.",
  ...
  const testimonials = [
    {
      name: "Rajesh Gupta",
      store: "Gupta Kirana & General Store, Delhi",
    ...
    },
    {
      ...
      quote: "Schedule H flags and batch expiry alerts saved us from billing expired medicines multiple times. Highly recommended for pharmacies!",
      rating: 5,
      vertical: "Pharmacy",
    },
  ];
  ...
  return (
    <div className="bg-[#0F1F35] text-slate-100 min-h-screen font-sans selection:bg-[#F5A623] selection:text-slate-950">
      ...
      <div className="bg-gradient-to-r from-amber-500 via-[#F5A623] to-orange-500 text-slate-950 px-4 py-2 text-center text-xs font-extrabold flex items-center justify-center gap-2 shadow-md">
        ...
        <span>DukaanPOS 2.0 Released: 100% Offline-First Multi-Vertical Retail Platform with GST, Udhaar & DPDP Security!</span>
        <button
          onClick={() => setActiveTab("pos")}
          className="underline hover:text-white transition ml-2 font-mono text-[11px]"
        >
          Try Live POS Counter →
        </button>
      </div>
      ...
      <section className="relative px-4 sm:px-6 lg:px-8 pt-12 pb-20 max-w-7xl mx-auto overflow-hidden">
        ...
        <div className="text-center space-y-6 max-w-4xl mx-auto relative z-10">
          <div className="inline-flex items-center gap-2 bg-white/10 border border-white/15 px-4 py-1.5 rounded-full text-xs font-bold text-amber-300">
            ...
            <span>🇮🇳 Built Specifically for Indian Retail Shops</span>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            ...
            >
              ...
              <span>Watch Video Walkthrough (40s)</span>
            </button>
          </div>
          ...
          <div className="bg-[#0F1F35] rounded-2xl max-w-3xl w-full overflow-hidden border-2 border-white/20 shadow-2xl">
            <div className="px-5 py-4 bg-slate-950 flex items-center justify-between border-b border-white/10">
              ...
              <button
                ...
                className="text-slate-400 hover:text-white px-2 py-1 rounded text-xs bg-white/10"
              >
                ✕ Close
              </button>
            </div>
      ...
      <section className="px-4 sm:px-6 lg:px-8 py-16 bg-slate-950/50 border-y border-white/10">
          ...
          {coreFeatures.map((f, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="pt-4 mt-4 border-t border-white/5 flex items-center text-xs font-bold text-[#F5A623] group-hover:translate-x-1 transition-transform">
